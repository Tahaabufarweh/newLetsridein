...
export class CompleteProfileComponent implements OnInit {
  ...
  get carBrand() {
    return this.EditProfileForm.get('carBrand') as FormControl;
  }

  get manufacturingYear() {
    return this.EditProfileForm.get('manufacturingYear') as FormControl;
  }

  get carModel() {
    return this.EditProfileForm.get('carModel') as FormControl;
  }

  get carColor() {
    return this.EditProfileForm.get('carColor') as FormControl;
...
{  viewValue: 'Zimbabwe',
  ...
  updateInfo() {
    ...
    this.user.carBrand = this.carBrand.value;
    this.user.carColor = this.carColor.value;
    this.user.carModel = this.carModel.value;
    this.user.manufacturingYear = this.manufacturingYear.value;
